...
public class SpectateActiveGameTests extends ProjectTest {
    ...
    public void testSpectateActiveValidGame()
    {
        ...
        boolean spectategameisvalid1 = this.joinexistinggame("hodbub" , "achiadg-poker-game",true);
        boolean spectategameisvalid2 = this.joinexistinggame("achiadg" , "hodbub-poker-game",true);
        boolean spectategameisvalid3 = this.joinexistinggame("rotemw" , "achiadg-poker-game",true);
        boolean spectategameisvalid4 = this.joinexistinggame("ronenbu" , "hodbub-poker-game",true);
    ...
    public void testSpectateActiveInValidGameName()
    {
        ...
        assertTrue(gamecreated1);
        assertTrue(gamecreated2);
        boolean spectategameisvalid1 = this.joinexistinggame("hodb\nub" , "achiadg-poker-game",true);
        boolean spectategameisvalid2 = this.joinexistinggame("ac\rhiadg" , "hodbub-poker-game",true);
        boolean spectategameisvalid3 = this.joinexistinggame("rotemw" , "achiadg-poke\tr-game",true);
        boolean spectategameisvalid4 = this.joinexistinggame("ronenbu" , "h\rodbub-poker-game",true);
        assertFalse(spectategameisvalid1);
        assertFalse(spectategameisvalid2);
        assertFalse(spectategameisvalid3);
        assertFalse(spectategameisvalid4);
    ...
    public void testSpectateActiveSqlInjection()
    {
        ...
        assertTrue(gamecreated1);
        boolean spectategameisvalid1 = this.joinexistinggame("achiadg" , "SELECT * FROM USERS WHERE username = achiadg-poker-game",true);
        assertFalse(spectategameisvalid1);
